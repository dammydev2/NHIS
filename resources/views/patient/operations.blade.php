	...
	<div class="row">
		...
		<div class="col-sm-10 col-lg-10 panel panel-primary row">
			...
			<div class="panel-body">
				...
				<form method="post" action="{{ url('/addoperation') }}">
					@csrf
					...
					<div class="form-group col-lg-4 col-sm-4">
						...
						<input type="text" readonly="" id="operation" name="operation" class="form-control operation">
					</div>
					...
					<div class="form-group col-lg-4 col-sm-4">
						...
						<select name="code" class="form-control js-example-basic-single" id='code'>
							...
							@foreach($data as $row)
							<option value="{{ $row->code }}" data-name="{{ $row->operation }}">{{ $row->code }}</option>
							@endforeach
						</select>
					</div>
